...
public abstract class AbstractTreeModel extends DefaultTreeModel {
     ...
     *            expected type of a root user object
    ...
    /**
     * Calls the {@link ITreeTransactionListener#start(AbstractTreeModel)} callback for all registered listeners.
     */
    ...
    /**
     * Calls the {@link ITreeTransactionListener#finish(AbstractTreeModel)} callback for all registered listeners.
     */
