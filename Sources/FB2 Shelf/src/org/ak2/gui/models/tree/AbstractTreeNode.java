...
public abstract class AbstractTreeNode<UserObjectType> implements MutableTreeNode, Cloneable {
     ...
     * @return the {@link TreeNode} in this node's child array at the specified index
    ...
    /**
     * Returns the index of <code>node</code> in the receivers children. If the receiver does not contain <code>node</code>, -1 will be returned.
     *
     * @param aChild
     *            the TreeNode to search for among this node's children
     * @return an int giving the index of the node in this node's child array, or <code>-1</code> if the specified node is a not a child of this node
     ...
     *
     * @return this node's parent {@link TreeNode}, or null if this node has no parent
    ...
    /**
     * Returns the parent <code>AbstractMutableNode</code> of the receiver.
     *
     * @return this node's parent {@link AbstractTreeNode}, or null if this node has no parent
     */
    ...
    /**
     * Adds <code>child</code> to the receiver at <code>index</code>. <code>child</code> will be messaged with <code>setParent</code>.
     *
     * @param child
     ...
     *
     * @param child
     *            the {@link AbstractTreeNode} to insert under this node
     * @param index
     *            the index in this node's child array where this node is to be inserted
     * @see javax.swing.tree.MutableTreeNode#insert(javax.swing.tree.MutableTreeNode, int)
     */
     ...
     * (Note that a node is considered an ancestor of itself.) If <code>anotherNode</code> is null, this method returns false. This operation is at worst O(h)
     * where h is the distance from the root to this node.
     *
     ...
     * <code>nextElement()</code> method is the leftmost leaf. This is the same as a depth-first traversal.
     * <P>
     *
     * Modifying the tree by inserting, removing, or moving a node invalidates any enumerations created before the modification.
     *
     ...
     * <code>nextElement()</code> method is the leftmost leaf. This is the same as a postorder traversal.
     * <P>
     *
     * Modifying the tree by inserting, removing, or moving a node invalidates any enumerations created before the modification.
     *
    ...
    /**
     * Creates and returns an enumeration that follows the path from <code>ancestor</code> to this node. The enumeration's <code>nextElement()</code> method
     * first returns <code>ancestor</code>, then the child of <code>ancestor</code> that is an ancestor of this node, and so on, and finally returns this node.
     * Creation of the enumeration is O(m) where m is the number of nodes between this node and <code>ancestor</code>, inclusive. Each
    ...
    /**
     * Builds the parents of node up to and including the root node, where the original node is the last element in the returned array. The length of the
    ...
    public boolean containsText(final String expected) {
        return SearchTreeModel.containsText(this.toString(), expected);
    }
    ...
    static final class PathBetweenNodesEnumeration implements Enumeration<AbstractTreeNode<?>> {
        ...
        public PathBetweenNodesEnumeration(final AbstractTreeNode<?> ancestor, final AbstractTreeNode<?> descendant) {
            super();
