...
public class XmlBuilder {
   ...
   * @return self
   */
  public XmlBuilder sequence(final String name, final String ns, final Collection<String> strings,
      final String... inners) {
    start(name, ns);
    for (final String str : strings) {
      for (final String tag : inners) {
   ...
   * @return self
   */
  public XmlBuilder sequenceOpt(final String name, final String ns, final Collection<String> strings,
      final String... inners) {
    if (LengthUtils.isNotEmpty(strings)) {
      start(name, ns);
      for (final String str : strings) {
