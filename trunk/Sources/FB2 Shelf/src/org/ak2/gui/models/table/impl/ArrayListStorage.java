 ...
 */
public class ArrayListStorage<Entity> implements IStorage<Entity> {
    private final ArrayList<Entity> fieldEntities;
     ...
     *            the entity array
     */
    public ArrayListStorage(final Entity[] array) {
        if (array != null) {
            fieldEntities = new ArrayList<Entity>(array.length);
            Collections.addAll(fieldEntities, array);
        } else {
            fieldEntities = new ArrayList<Entity>();
        }
    }
     ...
     */
    public ArrayListStorage(final Collection<Entity> c) {
        if (c != null) {
            fieldEntities = new ArrayList<Entity>(c);
        } else {
            fieldEntities = new ArrayList<Entity>();
        }
